...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "hidden !h-full w-[300px] flex-shrink-0 border-r border-main-border-light bg-white px-4 py-4 dark:border-main-border-dark dark:bg-main-bg-dark md:flex md:flex-col",
          className,
        )}
        animate={{
