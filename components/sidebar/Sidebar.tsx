...
const Dashboard = () => {
  return (
    <div className="flex flex-1 w-full">
      <div className="p-2 md:p-10 rounded-tl-2xl border border-neutral-200 dark:border-main-4 bg-white dark:bg-main-bg-dark flex flex-col gap-2 flex-1 w-full h-full">
